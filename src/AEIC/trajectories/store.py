...
class TrajectoryStore:
    ...
    def add(self, trajectory: Trajectory) -> int:
        ...
        # TODO: Do we want some sort of batching here? Save the pending indexes
        # to save and only write them when we reach a certain number or when
        # close() or sync() is called?
